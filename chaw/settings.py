...
SECRET_KEY = 'django-insecure-(vn$#aq#e1xt_w1e#bg6k0g6@(l$e2ee242kyk)0onzqui^&3v'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True
DEBUG = False

ALLOWED_HOSTS = ['54.84.239.184']
# ALLOWED_HOSTS = []
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'm.isimeto@gmail.com'
EMAIL_HOST_PASSWORD = 'nvulsacigekxsnph'
EMAIL_USE_TLS = True
# EMAIL SETTINGS DONE
